  ...
  return (
    <div className="min-h-screen bg-white p-4 ">
      <div className="text-left px-4 sm:px-6 lg:px-8 max-w-full pb-10">
        <h2 className="text-2xl sm:text-3xl text-center lg:text-4xl font-light text-gray-900 mb-4 tracking-tight">
          You Might <span className="font-bold text-gray-800">Intrested</span>
        </h2>
...
export default PropertyCardSlider1;
